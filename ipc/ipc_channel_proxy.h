...
//
class ChannelProxy : public Sender {
 public:
  ...
  class IMessageFilter {
   public:
	...
	virtual void OnFilterAdded(Channel* channel) = 0;
	...
	virtual void OnFilterRemoved() = 0;
  ...
  DWORD peer_pid() const { return context_->peer_pid_; }
